...
{\it netcat, or nc} is the tool that is available Linux distributions and commonly used to send the commands to the server over UDP sockets.
...
{\it nslookup and dig} are use to detect the problems with the DNS servers and queries. These tools are often used by network 
