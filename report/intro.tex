...
need to troubleshoot the network quite often. For that matter, in this document we discuss basic network
tools and techniques to measure and debug the network. We present the results of our experimental 
effort carried out in small network.
...
There is a humongous amount of protocols in modern networks: from L2 STP to Voice of IP at L4. But we are interetested in only 
few protocols that are common during basic network analysis and troubleshooting: We will cover L2 STP protocol, TCP, UDP, ICMP
...
which was captured in a small enterprise. 
