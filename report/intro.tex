...
designated ports if they have the shortest distance to the root bridge. The remaining ports become 
...
THese protocols have faster convergance time and can be used to defined different spanning trees
for each VLAN.
